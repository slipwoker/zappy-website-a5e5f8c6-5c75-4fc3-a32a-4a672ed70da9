    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "פרימיום פרינט משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'a5e5f8c6-5c75-4fc3-a32a-4a672ed70da9',
                    name: data.name || '',
                    email: data.email || '',
